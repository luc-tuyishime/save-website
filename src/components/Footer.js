          ...
          <div className="container main-footer">
            <div className="row">
              ...
              <div className="col-md-12">
                <div className="footer-title text-xs-center">
                  <img
                    className="save-logo footer-logo-padding  mx-auto d-block"
                    src={SaveLogo}
                    alt="save"
                  />
                  <p className="text-muted text-center text-footer-second">
                    copyright&#169;{new Date().getFullYear()}{" "}
                    <span className="exuus-style">
              ...
              <ul className="list-inline mx-auto d-block">
                ...
                <span id="vertLine" />
                <li className="list-inline-item">
                  <Link className="nav-link nav-footer" to="/pricing">
                    Pricing
                  </Link>
                </li>
                <span id="vertLine" />
                ...
                <li className="list-inline-item ">
                  <Link className="nav-link nav-footer" to="/developers">
                    Developers
                  </Link>
                </li>
                <span id="vertLine" />
                ...
                <li className="list-inline-item">
                  <Link className="nav-link nav-footer" to="/terms">
                    Terms and Policies
                  </Link>
                </li>
                <span id="vertLine" />
            ...
            <div className="row">
              <ul className="list-inline mx-auto d-blocks">
                <li className="list-inline-item zoomin">
                  {" "}
                  <a
                    href="https://twitter.com/getsave_io"
                    target="_blank"
                    className="nav-link"
                  >
                ...
                <li className="list-inline-item zoomin">
                  <a
                    href="https://www.instagram.com/getsave_io"
                    target="_blank"
                    className="nav-link"
                    to=""
                  >
                ...
                <li className="list-inline-item social-icon">
                  <a
                    href="https://www.facebook.com/Save-Platform-1886062638333239/"
                    target="_blank"
                    className="nav-link"
                    to=""
                  >
